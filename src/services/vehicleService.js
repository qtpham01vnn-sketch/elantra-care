...
const STORAGE_KEYS = {
  VEHICLE: 'elantra_app_vehicle_v4',
  SERVICE_LOGS: 'elantra_app_services_v4',
  FUEL_LOGS: 'elantra_app_fuel_v4',
  EXPENSES: 'elantra_app_expenses_v4',
  REMINDERS: 'elantra_app_reminders_v4',
};
